...
import type { CareersView } from '@/sanity/queries'
...
export default function CareersClient({ cms = {} }: { cms?: CareersView }) {
  ...
  const heroMutedColor = hasHeroImage ? 'rgba(255,255,255,0.82)' : MUTED
  ...
  return (
    <div className={`${cormorant.variable} ${dmSans.variable}`}>
      ...
      <section
        ...
        style={{
          minHeight: '52vh',
          backgroundColor: hasHeroImage ? INK : BEIGE,
      ...
      >
        ...
        <div className="relative max-w-[820px] mx-auto text-center">
          <p
            ...
            style={{ fontSize: 11, color: heroMutedColor, fontWeight: 500 }}
          >
            {cms.eyebrow}
          </p>
          <motion.h1
          ...
          <p
            ...
            style={{ fontSize: 'clamp(18px, 2vw, 24px)', color: heroMutedColor, fontWeight: 400 }}
          >
            {cms.tagline}
          </p>
          <p
            className={`${dmSans.className} mt-6 max-w-[58ch] mx-auto`}
            style={{ color: heroMutedColor, fontSize: 15, lineHeight: 1.7 }}
          >
            {cms.body}
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <div className="mt-12 flex flex-col items-center gap-4">
            ...
            >
              {status === 'sending' ? 'Sending…' : cms.submitLabel}
            </button>
